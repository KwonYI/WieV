...
//		return new ResponseEntity<>("면접관 자동 배정 완료", status);
	...
	public void sendMail(@Valid @RequestBody Interviewer interviewer) throws MessagingException {

		Company company = companyDao.findCompanyByComSeq(interviewer.getCareerCaSeq());
		...
		emailContent.append("  <table style=\"border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #fbfbfb;width:100%\" cellpadding=\"0\" cellspacing=\"0\">\r\n" + 
				...
				+ "<span style=\"color: #363d5a; font-size: 14px; line-height: 26.6px;\">이메일 : "+interviewer.getViewEmail()+"</span><br />"
				+ "<span style=\"color: #363d5a; font-size: 14px; line-height: 26.6px;\">비밀번호 : "+interviewer.getViewPassword()+"</span><br />"
				+ "</strong></span></p>\r\n" + 
				"  </div>\r\n" + 
				"\r\n" + 
				"      </td>\r\n" + 
				...
				"    <p style=\"font-size: 14px; line-height: 190%;\">"+interviewer.getViewName()+"님 안녕하세요.<br />위의 계정으로 로그인 후 면접을 진행해주세요.<br />감사합니다.</p>\r\n" + 
				"  </div>\r\n" + 
				"\r\n" + 
				"      </td>\r\n" + 
				"    </tr>\r\n" + 
		...
		emailService.sendMail(interviewer.getViewEmail(), "["+company.getComName()+"] "+interviewer.getViewName()+"님 면접 계정 안내",
